...
import {  getOutOfViewCasesManagementApi, addOutOfViewCaseApi, updateOutOfViewCaseApi, getForeignerByIdApi } from '../apiService';
...
const OutOfViewCasesPage = () => {
  ...
  const [, setLoadingCases] = useState(true); // WHAT CHANGED: Separate loading state for second table
