...
import { getForeignersApi, deleteForeignerApi, getVisitorRegistrationsApi, exportVisitorRegistrationsApi } from '../apiService';
...
const RegisteredArrivalsPage = () => {
  ...
  const applyFilter = useCallback((dataToFilter, currentTab, nationalityFilter) => {
  ...
  const fetchForeignersData = useCallback(async (tab = activeTab) => {
    setLoading(true);

    // Always fetch fresh data for 'Registered By Visitor' tab
    if (tab !== 'Registered By Visitor' && tabDataCache.current.has(tab)) {
    ...
    return data;
  }, [activeTab, selectedNationality, applyFilter]);
  ...
  const handleExportClick = async () => {
    try {
      if (activeTab === 'Registered By Visitor') {
        ...
        toast.success('Exported Registered By Visitor data successfully!');
      } else {
          ...
          <div className="flex flex-col space-y-4 mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                {/* Nationality Filter Dropdown - hidden for 'Registered By Visitor' tab */}
